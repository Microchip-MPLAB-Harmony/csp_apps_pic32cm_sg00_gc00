...
To clone or download this application from Github, go to the [main page of this repository](https://github.com/Microchip-MPLAB-Harmony/csp_apps_pic32cmsg_gc) and then click **Clone** button to clone this repository or download as zip file.
...
- Use a jumper wire to short the MISO (Pin 5) and MOSI (Pin 6) pins of the MikroBUS header
