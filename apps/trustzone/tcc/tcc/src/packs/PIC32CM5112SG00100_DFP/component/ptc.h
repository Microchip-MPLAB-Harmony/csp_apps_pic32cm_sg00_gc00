...
#define PTC_CTRLA_SWRST(value)                (PTC_CTRLA_SWRST_Msk & (_UINT32_(value) << PTC_CTRLA_SWRST_Pos)) /* Assigment of value for SWRST in the PTC_CTRLA register */
...
#define PTC_CTRLA_ENABLE(value)               (PTC_CTRLA_ENABLE_Msk & (_UINT32_(value) << PTC_CTRLA_ENABLE_Pos)) /* Assigment of value for ENABLE in the PTC_CTRLA register */
...
#define PTC_CTRLA_PRIV(value)                 (PTC_CTRLA_PRIV_Msk & (_UINT32_(value) << PTC_CTRLA_PRIV_Pos)) /* Assigment of value for PRIV in the PTC_CTRLA register */
...
#define PTC_CTRLA_RUNSTDBY(value)             (PTC_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << PTC_CTRLA_RUNSTDBY_Pos)) /* Assigment of value for RUNSTDBY in the PTC_CTRLA register */
...
#define PTC_CTRLA_ONDEMAND(value)             (PTC_CTRLA_ONDEMAND_Msk & (_UINT32_(value) << PTC_CTRLA_ONDEMAND_Pos)) /* Assigment of value for ONDEMAND in the PTC_CTRLA register */
...
#define PTC_EVCTRL_STCONVEI(value)            (PTC_EVCTRL_STCONVEI_Msk & (_UINT32_(value) << PTC_EVCTRL_STCONVEI_Pos)) /* Assigment of value for STCONVEI in the PTC_EVCTRL register */
...
#define PTC_EVCTRL_DSEQREI(value)             (PTC_EVCTRL_DSEQREI_Msk & (_UINT32_(value) << PTC_EVCTRL_DSEQREI_Pos)) /* Assigment of value for DSEQREI in the PTC_EVCTRL register */
...
#define PTC_EVCTRL_STCONVINV(value)           (PTC_EVCTRL_STCONVINV_Msk & (_UINT32_(value) << PTC_EVCTRL_STCONVINV_Pos)) /* Assigment of value for STCONVINV in the PTC_EVCTRL register */
...
#define PTC_EVCTRL_DSEQRINV(value)            (PTC_EVCTRL_DSEQRINV_Msk & (_UINT32_(value) << PTC_EVCTRL_DSEQRINV_Pos)) /* Assigment of value for DSEQRINV in the PTC_EVCTRL register */
...
#define PTC_EVCTRL_EOCEO(value)               (PTC_EVCTRL_EOCEO_Msk & (_UINT32_(value) << PTC_EVCTRL_EOCEO_Pos)) /* Assigment of value for EOCEO in the PTC_EVCTRL register */
...
#define PTC_EVCTRL_WCOMPEO(value)             (PTC_EVCTRL_WCOMPEO_Msk & (_UINT32_(value) << PTC_EVCTRL_WCOMPEO_Pos)) /* Assigment of value for WCOMPEO in the PTC_EVCTRL register */
...
#define PTC_DBGCTRL_DBGRUN(value)             (PTC_DBGCTRL_DBGRUN_Msk & (_UINT32_(value) << PTC_DBGCTRL_DBGRUN_Pos)) /* Assigment of value for DBGRUN in the PTC_DBGCTRL register */
...
#define PTC_CTRLB_CTSM(value)                 (PTC_CTRLB_CTSM_Msk & (_UINT32_(value) << PTC_CTRLB_CTSM_Pos)) /* Assigment of value for CTSM in the PTC_CTRLB register */
...
#define PTC_CTRLB_INTSEL(value)               (PTC_CTRLB_INTSEL_Msk & (_UINT32_(value) << PTC_CTRLB_INTSEL_Pos)) /* Assigment of value for INTSEL in the PTC_CTRLB register */
...
#define PTC_CTRLB_SDS(value)                  (PTC_CTRLB_SDS_Msk & (_UINT32_(value) << PTC_CTRLB_SDS_Pos)) /* Assigment of value for SDS in the PTC_CTRLB register */
...
#define PTC_CTRLB_ASDV(value)                 (PTC_CTRLB_ASDV_Msk & (_UINT32_(value) << PTC_CTRLB_ASDV_Pos)) /* Assigment of value for ASDV in the PTC_CTRLB register */
...
#define PTC_CTRLB_CCDS(value)                 (PTC_CTRLB_CCDS_Msk & (_UINT32_(value) << PTC_CTRLB_CCDS_Pos)) /* Assigment of value for CCDS in the PTC_CTRLB register */
...
#define PTC_CTRLB_RSEL(value)                 (PTC_CTRLB_RSEL_Msk & (_UINT32_(value) << PTC_CTRLB_RSEL_Pos)) /* Assigment of value for RSEL in the PTC_CTRLB register */
...
#define PTC_CTRLC_CCF(value)                  (PTC_CTRLC_CCF_Msk & (_UINT32_(value) << PTC_CTRLC_CCF_Pos)) /* Assigment of value for CCF in the PTC_CTRLC register */
...
#define PTC_CTRLC_CCC(value)                  (PTC_CTRLC_CCC_Msk & (_UINT32_(value) << PTC_CTRLC_CCC_Pos)) /* Assigment of value for CCC in the PTC_CTRLC register */
...
#define PTC_CTRLC_CI(value)                   (PTC_CTRLC_CI_Msk & (_UINT32_(value) << PTC_CTRLC_CI_Pos)) /* Assigment of value for CI in the PTC_CTRLC register */
...
#define PTC_CTRLC_CSD(value)                  (PTC_CTRLC_CSD_Msk & (_UINT32_(value) << PTC_CTRLC_CSD_Pos)) /* Assigment of value for CSD in the PTC_CTRLC register */
...
#define PTC_CTRLD_DAN(value)                  (PTC_CTRLD_DAN_Msk & (_UINT32_(value) << PTC_CTRLD_DAN_Pos)) /* Assigment of value for DAN in the PTC_CTRLD register */
...
#define PTC_CTRLD_AAN(value)                  (PTC_CTRLD_AAN_Msk & (_UINT32_(value) << PTC_CTRLD_AAN_Pos)) /* Assigment of value for AAN in the PTC_CTRLD register */
...
#define PTC_CTRLD_WINCM(value)                (PTC_CTRLD_WINCM_Msk & (_UINT32_(value) << PTC_CTRLD_WINCM_Pos)) /* Assigment of value for WINCM in the PTC_CTRLD register */
...
#define PTC_CTRLD_WINSS(value)                (PTC_CTRLD_WINSS_Msk & (_UINT32_(value) << PTC_CTRLD_WINSS_Pos)) /* Assigment of value for WINSS in the PTC_CTRLD register */
...
#define PTC_CTRLD_EXTCIEN(value)              (PTC_CTRLD_EXTCIEN_Msk & (_UINT32_(value) << PTC_CTRLD_EXTCIEN_Pos)) /* Assigment of value for EXTCIEN in the PTC_CTRLD register */
...
#define PTC_CTRLD_POLICC(value)               (PTC_CTRLD_POLICC_Msk & (_UINT32_(value) << PTC_CTRLD_POLICC_Pos)) /* Assigment of value for POLICC in the PTC_CTRLD register */
...
#define PTC_CTRLD_DSEN(value)                 (PTC_CTRLD_DSEN_Msk & (_UINT32_(value) << PTC_CTRLD_DSEN_Pos)) /* Assigment of value for DSEN in the PTC_CTRLD register */
...
#define PTC_CTRLD_DSEQSTOP(value)             (PTC_CTRLD_DSEQSTOP_Msk & (_UINT32_(value) << PTC_CTRLD_DSEQSTOP_Pos)) /* Assigment of value for DSEQSTOP in the PTC_CTRLD register */
...
#define PTC_CTRLE_AIPMPEN(value)              (PTC_CTRLE_AIPMPEN_Msk & (_UINT32_(value) << PTC_CTRLE_AIPMPEN_Pos)) /* Assigment of value for AIPMPEN in the PTC_CTRLE register */
...
#define PTC_CTRLE_PRSC(value)                 (PTC_CTRLE_PRSC_Msk & (_UINT32_(value) << PTC_CTRLE_PRSC_Pos)) /* Assigment of value for PRSC in the PTC_CTRLE register */
...
#define PTC_CTRLE_WKUPEXP(value)              (PTC_CTRLE_WKUPEXP_Msk & (_UINT32_(value) << PTC_CTRLE_WKUPEXP_Pos)) /* Assigment of value for WKUPEXP in the PTC_CTRLE register */
...
#define PTC_SWTRIG_STCONV(value)              (PTC_SWTRIG_STCONV_Msk & (_UINT32_(value) << PTC_SWTRIG_STCONV_Pos)) /* Assigment of value for STCONV in the PTC_SWTRIG register */
...
#define PTC_WINLT_WCLT(value)                 (PTC_WINLT_WCLT_Msk & (_UINT32_(value) << PTC_WINLT_WCLT_Pos)) /* Assigment of value for WCLT in the PTC_WINLT register */
...
#define PTC_WINHT_WCHT(value)                 (PTC_WINHT_WCHT_Msk & (_UINT32_(value) << PTC_WINHT_WCHT_Pos)) /* Assigment of value for WCHT in the PTC_WINHT register */
...
#define PTC_PINEN1_PINEN(value)               (PTC_PINEN1_PINEN_Msk & (_UINT32_(value) << PTC_PINEN1_PINEN_Pos)) /* Assigment of value for PINEN in the PTC_PINEN1 register */
...
#define PTC_PINEN2_PINEN(value)               (PTC_PINEN2_PINEN_Msk & (_UINT32_(value) << PTC_PINEN2_PINEN_Pos)) /* Assigment of value for PINEN in the PTC_PINEN2 register */
...
#define PTC_XSEL1_XSEL(value)                 (PTC_XSEL1_XSEL_Msk & (_UINT32_(value) << PTC_XSEL1_XSEL_Pos)) /* Assigment of value for XSEL in the PTC_XSEL1 register */
...
#define PTC_XSEL2_XSEL(value)                 (PTC_XSEL2_XSEL_Msk & (_UINT32_(value) << PTC_XSEL2_XSEL_Pos)) /* Assigment of value for XSEL in the PTC_XSEL2 register */
...
#define PTC_YSEL1_YSEL(value)                 (PTC_YSEL1_YSEL_Msk & (_UINT32_(value) << PTC_YSEL1_YSEL_Pos)) /* Assigment of value for YSEL in the PTC_YSEL1 register */
...
#define PTC_YSEL2_YSEL(value)                 (PTC_YSEL2_YSEL_Msk & (_UINT32_(value) << PTC_YSEL2_YSEL_Pos)) /* Assigment of value for YSEL in the PTC_YSEL2 register */
...
#define PTC_POLCTRL1_POLARITY(value)          (PTC_POLCTRL1_POLARITY_Msk & (_UINT32_(value) << PTC_POLCTRL1_POLARITY_Pos)) /* Assigment of value for POLARITY in the PTC_POLCTRL1 register */
...
#define PTC_POLCTRL2_POLARITY(value)          (PTC_POLCTRL2_POLARITY_Msk & (_UINT32_(value) << PTC_POLCTRL2_POLARITY_Pos)) /* Assigment of value for POLARITY in the PTC_POLCTRL2 register */
...
#define PTC_INTENCLR_EOC(value)               (PTC_INTENCLR_EOC_Msk & (_UINT32_(value) << PTC_INTENCLR_EOC_Pos)) /* Assigment of value for EOC in the PTC_INTENCLR register */
...
#define PTC_INTENCLR_WCOMP(value)             (PTC_INTENCLR_WCOMP_Msk & (_UINT32_(value) << PTC_INTENCLR_WCOMP_Pos)) /* Assigment of value for WCOMP in the PTC_INTENCLR register */
...
#define PTC_INTENCLR_ACRRDY(value)            (PTC_INTENCLR_ACRRDY_Msk & (_UINT32_(value) << PTC_INTENCLR_ACRRDY_Pos)) /* Assigment of value for ACRRDY in the PTC_INTENCLR register */
...
#define PTC_INTENSET_EOC(value)               (PTC_INTENSET_EOC_Msk & (_UINT32_(value) << PTC_INTENSET_EOC_Pos)) /* Assigment of value for EOC in the PTC_INTENSET register */
...
#define PTC_INTENSET_WCOMP(value)             (PTC_INTENSET_WCOMP_Msk & (_UINT32_(value) << PTC_INTENSET_WCOMP_Pos)) /* Assigment of value for WCOMP in the PTC_INTENSET register */
...
#define PTC_INTENSET_ACRRDY(value)            (PTC_INTENSET_ACRRDY_Msk & (_UINT32_(value) << PTC_INTENSET_ACRRDY_Pos)) /* Assigment of value for ACRRDY in the PTC_INTENSET register */
...
#define PTC_INTFLAGSET_EOC(value)             (PTC_INTFLAGSET_EOC_Msk & (_UINT32_(value) << PTC_INTFLAGSET_EOC_Pos)) /* Assigment of value for EOC in the PTC_INTFLAGSET register */
...
#define PTC_INTFLAGSET_WCOMP(value)           (PTC_INTFLAGSET_WCOMP_Msk & (_UINT32_(value) << PTC_INTFLAGSET_WCOMP_Pos)) /* Assigment of value for WCOMP in the PTC_INTFLAGSET register */
...
#define PTC_INTFLAGSET_ACRRDY(value)          (PTC_INTFLAGSET_ACRRDY_Msk & (_UINT32_(value) << PTC_INTFLAGSET_ACRRDY_Pos)) /* Assigment of value for ACRRDY in the PTC_INTFLAGSET register */
...
#define PTC_INTFLAG_EOC(value)                (PTC_INTFLAG_EOC_Msk & (_UINT32_(value) << PTC_INTFLAG_EOC_Pos)) /* Assigment of value for EOC in the PTC_INTFLAG register */
...
#define PTC_INTFLAG_WCOMP(value)              (PTC_INTFLAG_WCOMP_Msk & (_UINT32_(value) << PTC_INTFLAG_WCOMP_Pos)) /* Assigment of value for WCOMP in the PTC_INTFLAG register */
...
#define PTC_INTFLAG_ACRRDY(value)             (PTC_INTFLAG_ACRRDY_Msk & (_UINT32_(value) << PTC_INTFLAG_ACRRDY_Pos)) /* Assigment of value for ACRRDY in the PTC_INTFLAG register */
...
#define PTC_STATUS_PTCBUSY(value)             (PTC_STATUS_PTCBUSY_Msk & (_UINT32_(value) << PTC_STATUS_PTCBUSY_Pos)) /* Assigment of value for PTCBUSY in the PTC_STATUS register */
...
#define PTC_STATUS_DAD(value)                 (PTC_STATUS_DAD_Msk & (_UINT32_(value) << PTC_STATUS_DAD_Pos)) /* Assigment of value for DAD in the PTC_STATUS register */
...
#define PTC_STATUS_WCC(value)                 (PTC_STATUS_WCC_Msk & (_UINT32_(value) << PTC_STATUS_WCC_Pos)) /* Assigment of value for WCC in the PTC_STATUS register */
...
#define PTC_SYNCBUSY_SWRST(value)             (PTC_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << PTC_SYNCBUSY_SWRST_Pos)) /* Assigment of value for SWRST in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_ENABLE(value)            (PTC_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << PTC_SYNCBUSY_ENABLE_Pos)) /* Assigment of value for ENABLE in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_CTRLB(value)             (PTC_SYNCBUSY_CTRLB_Msk & (_UINT32_(value) << PTC_SYNCBUSY_CTRLB_Pos)) /* Assigment of value for CTRLB in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_CTRLC(value)             (PTC_SYNCBUSY_CTRLC_Msk & (_UINT32_(value) << PTC_SYNCBUSY_CTRLC_Pos)) /* Assigment of value for CTRLC in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_CTRLD(value)             (PTC_SYNCBUSY_CTRLD_Msk & (_UINT32_(value) << PTC_SYNCBUSY_CTRLD_Pos)) /* Assigment of value for CTRLD in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_SWTRIG(value)            (PTC_SYNCBUSY_SWTRIG_Msk & (_UINT32_(value) << PTC_SYNCBUSY_SWTRIG_Pos)) /* Assigment of value for SWTRIG in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_WINLT(value)             (PTC_SYNCBUSY_WINLT_Msk & (_UINT32_(value) << PTC_SYNCBUSY_WINLT_Pos)) /* Assigment of value for WINLT in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_WINHT(value)             (PTC_SYNCBUSY_WINHT_Msk & (_UINT32_(value) << PTC_SYNCBUSY_WINHT_Pos)) /* Assigment of value for WINHT in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_XSEL1(value)             (PTC_SYNCBUSY_XSEL1_Msk & (_UINT32_(value) << PTC_SYNCBUSY_XSEL1_Pos)) /* Assigment of value for XSEL1 in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_XSEL2(value)             (PTC_SYNCBUSY_XSEL2_Msk & (_UINT32_(value) << PTC_SYNCBUSY_XSEL2_Pos)) /* Assigment of value for XSEL2 in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_YSEL1(value)             (PTC_SYNCBUSY_YSEL1_Msk & (_UINT32_(value) << PTC_SYNCBUSY_YSEL1_Pos)) /* Assigment of value for YSEL1 in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_YSEL2(value)             (PTC_SYNCBUSY_YSEL2_Msk & (_UINT32_(value) << PTC_SYNCBUSY_YSEL2_Pos)) /* Assigment of value for YSEL2 in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_POLCTRL1(value)          (PTC_SYNCBUSY_POLCTRL1_Msk & (_UINT32_(value) << PTC_SYNCBUSY_POLCTRL1_Pos)) /* Assigment of value for POLCTRL1 in the PTC_SYNCBUSY register */
...
#define PTC_SYNCBUSY_POLCTRL2(value)          (PTC_SYNCBUSY_POLCTRL2_Msk & (_UINT32_(value) << PTC_SYNCBUSY_POLCTRL2_Pos)) /* Assigment of value for POLCTRL2 in the PTC_SYNCBUSY register */
...
#define PTC_DSEQCTRL_CTRLD(value)             (PTC_DSEQCTRL_CTRLD_Msk & (_UINT32_(value) << PTC_DSEQCTRL_CTRLD_Pos)) /* Assigment of value for CTRLD in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_WINLT(value)             (PTC_DSEQCTRL_WINLT_Msk & (_UINT32_(value) << PTC_DSEQCTRL_WINLT_Pos)) /* Assigment of value for WINLT in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_WINHT(value)             (PTC_DSEQCTRL_WINHT_Msk & (_UINT32_(value) << PTC_DSEQCTRL_WINHT_Pos)) /* Assigment of value for WINHT in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_XSEL(value)              (PTC_DSEQCTRL_XSEL_Msk & (_UINT32_(value) << PTC_DSEQCTRL_XSEL_Pos)) /* Assigment of value for XSEL in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_YSEL(value)              (PTC_DSEQCTRL_YSEL_Msk & (_UINT32_(value) << PTC_DSEQCTRL_YSEL_Pos)) /* Assigment of value for YSEL in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_POL(value)               (PTC_DSEQCTRL_POL_Msk & (_UINT32_(value) << PTC_DSEQCTRL_POL_Pos)) /* Assigment of value for POL in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_CC(value)                (PTC_DSEQCTRL_CC_Msk & (_UINT32_(value) << PTC_DSEQCTRL_CC_Pos)) /* Assigment of value for CC in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_CI(value)                (PTC_DSEQCTRL_CI_Msk & (_UINT32_(value) << PTC_DSEQCTRL_CI_Pos)) /* Assigment of value for CI in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_CSD(value)               (PTC_DSEQCTRL_CSD_Msk & (_UINT32_(value) << PTC_DSEQCTRL_CSD_Pos)) /* Assigment of value for CSD in the PTC_DSEQCTRL register */
...
#define PTC_DSEQCTRL_AUTOSTART(value)         (PTC_DSEQCTRL_AUTOSTART_Msk & (_UINT32_(value) << PTC_DSEQCTRL_AUTOSTART_Pos)) /* Assigment of value for AUTOSTART in the PTC_DSEQCTRL register */
...
#define PTC_DSEQSTAT_CTRLD(value)             (PTC_DSEQSTAT_CTRLD_Msk & (_UINT32_(value) << PTC_DSEQSTAT_CTRLD_Pos)) /* Assigment of value for CTRLD in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_WINLT(value)             (PTC_DSEQSTAT_WINLT_Msk & (_UINT32_(value) << PTC_DSEQSTAT_WINLT_Pos)) /* Assigment of value for WINLT in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_WINHT(value)             (PTC_DSEQSTAT_WINHT_Msk & (_UINT32_(value) << PTC_DSEQSTAT_WINHT_Pos)) /* Assigment of value for WINHT in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_XSEL(value)              (PTC_DSEQSTAT_XSEL_Msk & (_UINT32_(value) << PTC_DSEQSTAT_XSEL_Pos)) /* Assigment of value for XSEL in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_YSEL(value)              (PTC_DSEQSTAT_YSEL_Msk & (_UINT32_(value) << PTC_DSEQSTAT_YSEL_Pos)) /* Assigment of value for YSEL in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_POL(value)               (PTC_DSEQSTAT_POL_Msk & (_UINT32_(value) << PTC_DSEQSTAT_POL_Pos)) /* Assigment of value for POL in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_CC(value)                (PTC_DSEQSTAT_CC_Msk & (_UINT32_(value) << PTC_DSEQSTAT_CC_Pos)) /* Assigment of value for CC in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_CI(value)                (PTC_DSEQSTAT_CI_Msk & (_UINT32_(value) << PTC_DSEQSTAT_CI_Pos)) /* Assigment of value for CI in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_CSD(value)               (PTC_DSEQSTAT_CSD_Msk & (_UINT32_(value) << PTC_DSEQSTAT_CSD_Pos)) /* Assigment of value for CSD in the PTC_DSEQSTAT register */
...
#define PTC_DSEQSTAT_BUSY(value)              (PTC_DSEQSTAT_BUSY_Msk & (_UINT32_(value) << PTC_DSEQSTAT_BUSY_Pos)) /* Assigment of value for BUSY in the PTC_DSEQSTAT register */
...
#define PTC_DSEQDATA_DATA(value)              (PTC_DSEQDATA_DATA_Msk & (_UINT32_(value) << PTC_DSEQDATA_DATA_Pos)) /* Assigment of value for DATA in the PTC_DSEQDATA register */
...
#define PTC_RESULT_RES(value)                 (PTC_RESULT_RES_Msk & (_UINT32_(value) << PTC_RESULT_RES_Pos)) /* Assigment of value for RES in the PTC_RESULT register */
...
#define PTC_RESULT_ACCRES(value)              (PTC_RESULT_ACCRES_Msk & (_UINT32_(value) << PTC_RESULT_ACCRES_Pos)) /* Assigment of value for ACCRES in the PTC_RESULT register */
