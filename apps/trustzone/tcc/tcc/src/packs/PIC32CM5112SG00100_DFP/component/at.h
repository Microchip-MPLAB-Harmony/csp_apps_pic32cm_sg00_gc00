...
#define AT_CTRLA_SWRST(value)                 (AT_CTRLA_SWRST_Msk & (_UINT32_(value) << AT_CTRLA_SWRST_Pos)) /* Assigment of value for SWRST in the AT_CTRLA register */
...
#define AT_CTRLA_PRIV(value)                  (AT_CTRLA_PRIV_Msk & (_UINT32_(value) << AT_CTRLA_PRIV_Pos)) /* Assigment of value for PRIV in the AT_CTRLA register */
...
#define AT_CTRLA_RUNSTDBY(value)              (AT_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << AT_CTRLA_RUNSTDBY_Pos)) /* Assigment of value for RUNSTDBY in the AT_CTRLA register */
...
#define AT_TAMPER_KEY_TAMPERKEY(value)        (AT_TAMPER_KEY_TAMPERKEY_Msk & (_UINT32_(value) << AT_TAMPER_KEY_TAMPERKEY_Pos)) /* Assigment of value for TAMPERKEY in the AT_TAMPER_KEY register */
...
#define AT_anti_tamper__LEVELA_LEVEL0(value)  (AT_anti_tamper__LEVELA_LEVEL0_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL0_Pos)) /* Assigment of value for LEVEL0 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL1(value)  (AT_anti_tamper__LEVELA_LEVEL1_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL1_Pos)) /* Assigment of value for LEVEL1 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL2(value)  (AT_anti_tamper__LEVELA_LEVEL2_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL2_Pos)) /* Assigment of value for LEVEL2 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL3(value)  (AT_anti_tamper__LEVELA_LEVEL3_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL3_Pos)) /* Assigment of value for LEVEL3 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL4(value)  (AT_anti_tamper__LEVELA_LEVEL4_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL4_Pos)) /* Assigment of value for LEVEL4 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL5(value)  (AT_anti_tamper__LEVELA_LEVEL5_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL5_Pos)) /* Assigment of value for LEVEL5 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL6(value)  (AT_anti_tamper__LEVELA_LEVEL6_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL6_Pos)) /* Assigment of value for LEVEL6 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELA_LEVEL7(value)  (AT_anti_tamper__LEVELA_LEVEL7_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELA_LEVEL7_Pos)) /* Assigment of value for LEVEL7 in the AT_anti_tamper__LEVELA register */
...
#define AT_anti_tamper__LEVELB_LEVEL8(value)  (AT_anti_tamper__LEVELB_LEVEL8_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL8_Pos)) /* Assigment of value for LEVEL8 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL9(value)  (AT_anti_tamper__LEVELB_LEVEL9_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL9_Pos)) /* Assigment of value for LEVEL9 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL10(value) (AT_anti_tamper__LEVELB_LEVEL10_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL10_Pos)) /* Assigment of value for LEVEL10 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL11(value) (AT_anti_tamper__LEVELB_LEVEL11_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL11_Pos)) /* Assigment of value for LEVEL11 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL12(value) (AT_anti_tamper__LEVELB_LEVEL12_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL12_Pos)) /* Assigment of value for LEVEL12 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL13(value) (AT_anti_tamper__LEVELB_LEVEL13_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL13_Pos)) /* Assigment of value for LEVEL13 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL14(value) (AT_anti_tamper__LEVELB_LEVEL14_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL14_Pos)) /* Assigment of value for LEVEL14 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELB_LEVEL15(value) (AT_anti_tamper__LEVELB_LEVEL15_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELB_LEVEL15_Pos)) /* Assigment of value for LEVEL15 in the AT_anti_tamper__LEVELB register */
...
#define AT_anti_tamper__LEVELC_LEVEL16(value) (AT_anti_tamper__LEVELC_LEVEL16_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL16_Pos)) /* Assigment of value for LEVEL16 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL17(value) (AT_anti_tamper__LEVELC_LEVEL17_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL17_Pos)) /* Assigment of value for LEVEL17 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL18(value) (AT_anti_tamper__LEVELC_LEVEL18_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL18_Pos)) /* Assigment of value for LEVEL18 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL19(value) (AT_anti_tamper__LEVELC_LEVEL19_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL19_Pos)) /* Assigment of value for LEVEL19 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL20(value) (AT_anti_tamper__LEVELC_LEVEL20_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL20_Pos)) /* Assigment of value for LEVEL20 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL21(value) (AT_anti_tamper__LEVELC_LEVEL21_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL21_Pos)) /* Assigment of value for LEVEL21 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL22(value) (AT_anti_tamper__LEVELC_LEVEL22_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL22_Pos)) /* Assigment of value for LEVEL22 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELC_LEVEL23(value) (AT_anti_tamper__LEVELC_LEVEL23_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELC_LEVEL23_Pos)) /* Assigment of value for LEVEL23 in the AT_anti_tamper__LEVELC register */
...
#define AT_anti_tamper__LEVELD_LEVEL24(value) (AT_anti_tamper__LEVELD_LEVEL24_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL24_Pos)) /* Assigment of value for LEVEL24 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL25(value) (AT_anti_tamper__LEVELD_LEVEL25_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL25_Pos)) /* Assigment of value for LEVEL25 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL26(value) (AT_anti_tamper__LEVELD_LEVEL26_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL26_Pos)) /* Assigment of value for LEVEL26 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL27(value) (AT_anti_tamper__LEVELD_LEVEL27_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL27_Pos)) /* Assigment of value for LEVEL27 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL28(value) (AT_anti_tamper__LEVELD_LEVEL28_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL28_Pos)) /* Assigment of value for LEVEL28 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL29(value) (AT_anti_tamper__LEVELD_LEVEL29_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL29_Pos)) /* Assigment of value for LEVEL29 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL30(value) (AT_anti_tamper__LEVELD_LEVEL30_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL30_Pos)) /* Assigment of value for LEVEL30 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__LEVELD_LEVEL31(value) (AT_anti_tamper__LEVELD_LEVEL31_Msk & (_UINT32_(value) << AT_anti_tamper__LEVELD_LEVEL31_Pos)) /* Assigment of value for LEVEL31 in the AT_anti_tamper__LEVELD register */
...
#define AT_anti_tamper__SETLEVEL_LEVEL(value) (AT_anti_tamper__SETLEVEL_LEVEL_Msk & (_UINT32_(value) << AT_anti_tamper__SETLEVEL_LEVEL_Pos)) /* Assigment of value for LEVEL in the AT_anti_tamper__SETLEVEL register */
...
#define AT_anti_tamper__SETLEVEL_ID(value)    (AT_anti_tamper__SETLEVEL_ID_Msk & (_UINT32_(value) << AT_anti_tamper__SETLEVEL_ID_Pos)) /* Assigment of value for ID in the AT_anti_tamper__SETLEVEL register */
...
#define AT_anti_tamper__SETLEVEL_PROTKEY(value) (AT_anti_tamper__SETLEVEL_PROTKEY_Msk & (_UINT32_(value) << AT_anti_tamper__SETLEVEL_PROTKEY_Pos)) /* Assigment of value for PROTKEY in the AT_anti_tamper__SETLEVEL register */
...
#define AT_anti_tamper__FILTERCFG_THRESH(value) (AT_anti_tamper__FILTERCFG_THRESH_Msk & (_UINT32_(value) << AT_anti_tamper__FILTERCFG_THRESH_Pos)) /* Assigment of value for THRESH in the AT_anti_tamper__FILTERCFG register */
...
#define AT_anti_tamper__FILTERCFG_PERIOD(value) (AT_anti_tamper__FILTERCFG_PERIOD_Msk & (_UINT32_(value) << AT_anti_tamper__FILTERCFG_PERIOD_Pos)) /* Assigment of value for PERIOD in the AT_anti_tamper__FILTERCFG register */
...
#define AT_anti_tamper__FILTERCFG_PROTKEY(value) (AT_anti_tamper__FILTERCFG_PROTKEY_Msk & (_UINT32_(value) << AT_anti_tamper__FILTERCFG_PROTKEY_Pos)) /* Assigment of value for PROTKEY in the AT_anti_tamper__FILTERCFG register */
...
#define AT_anti_tamper__SOFTTAMP_ACTIVE(value) (AT_anti_tamper__SOFTTAMP_ACTIVE_Msk & (_UINT32_(value) << AT_anti_tamper__SOFTTAMP_ACTIVE_Pos)) /* Assigment of value for ACTIVE in the AT_anti_tamper__SOFTTAMP register */
...
#define AT_anti_tamper__SOFTTAMP_ID(value)    (AT_anti_tamper__SOFTTAMP_ID_Msk & (_UINT32_(value) << AT_anti_tamper__SOFTTAMP_ID_Pos)) /* Assigment of value for ID in the AT_anti_tamper__SOFTTAMP register */
...
#define AT_anti_tamper__SOFTTAMP_PROTKEY(value) (AT_anti_tamper__SOFTTAMP_PROTKEY_Msk & (_UINT32_(value) << AT_anti_tamper__SOFTTAMP_PROTKEY_Pos)) /* Assigment of value for PROTKEY in the AT_anti_tamper__SOFTTAMP register */
...
#define AT_anti_tamper__RAWSTAT_RAWSTAT(value) (AT_anti_tamper__RAWSTAT_RAWSTAT_Msk & (_UINT32_(value) << AT_anti_tamper__RAWSTAT_RAWSTAT_Pos)) /* Assigment of value for RAWSTAT in the AT_anti_tamper__RAWSTAT register */
...
#define AT_anti_tamper__STAT_STAT(value)      (AT_anti_tamper__STAT_STAT_Msk & (_UINT32_(value) << AT_anti_tamper__STAT_STAT_Pos)) /* Assigment of value for STAT in the AT_anti_tamper__STAT register */
...
#define AT_anti_tamper__TIMESTAMP_TIMESTAMP(value) (AT_anti_tamper__TIMESTAMP_TIMESTAMP_Msk & (_UINT32_(value) << AT_anti_tamper__TIMESTAMP_TIMESTAMP_Pos)) /* Assigment of value for TIMESTAMP in the AT_anti_tamper__TIMESTAMP register */
...
#define AT_anti_tamper__FILTERCNT_FILTERCNT(value) (AT_anti_tamper__FILTERCNT_FILTERCNT_Msk & (_UINT32_(value) << AT_anti_tamper__FILTERCNT_FILTERCNT_Pos)) /* Assigment of value for FILTERCNT in the AT_anti_tamper__FILTERCNT register */
...
#define AT_anti_tamper__SOFTINFO_SOFTINFO(value) (AT_anti_tamper__SOFTINFO_SOFTINFO_Msk & (_UINT32_(value) << AT_anti_tamper__SOFTINFO_SOFTINFO_Pos)) /* Assigment of value for SOFTINFO in the AT_anti_tamper__SOFTINFO register */
...
#define AT_anti_tamper__TAMPERFLAG_TAMPERFLAG(value) (AT_anti_tamper__TAMPERFLAG_TAMPERFLAG_Msk & (_UINT32_(value) << AT_anti_tamper__TAMPERFLAG_TAMPERFLAG_Pos)) /* Assigment of value for TAMPERFLAG in the AT_anti_tamper__TAMPERFLAG register */
...
#define AT_anti_tamper__SOFTRESET_SOFTRESET(value) (AT_anti_tamper__SOFTRESET_SOFTRESET_Msk & (_UINT32_(value) << AT_anti_tamper__SOFTRESET_SOFTRESET_Pos)) /* Assigment of value for SOFTRESET in the AT_anti_tamper__SOFTRESET register */
#define AT_anti_tamper__SOFTRESET_Msk         _UINT32_(0x00000001)                                 /* (AT_anti_tamper__SOFTRESET) Register Mask  */


/** \brief AT register offsets definitions */
...
/** \brief AT register API structure */
typedef struct
