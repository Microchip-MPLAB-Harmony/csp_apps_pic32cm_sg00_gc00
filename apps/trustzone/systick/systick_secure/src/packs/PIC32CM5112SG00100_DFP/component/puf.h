...
#define PUF_CTRLA_SWRST(value)                (PUF_CTRLA_SWRST_Msk & (_UINT32_(value) << PUF_CTRLA_SWRST_Pos)) /* Assigment of value for SWRST in the PUF_CTRLA register */
...
#define PUF_CTRLA_ENABLE(value)               (PUF_CTRLA_ENABLE_Msk & (_UINT32_(value) << PUF_CTRLA_ENABLE_Pos)) /* Assigment of value for ENABLE in the PUF_CTRLA register */
...
#define PUF_CTRLA_PRIV(value)                 (PUF_CTRLA_PRIV_Msk & (_UINT32_(value) << PUF_CTRLA_PRIV_Pos)) /* Assigment of value for PRIV in the PUF_CTRLA register */
...
#define PUF_CTRLA_RUNSTDBY(value)             (PUF_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << PUF_CTRLA_RUNSTDBY_Pos)) /* Assigment of value for RUNSTDBY in the PUF_CTRLA register */
...
#define PUF_STATUSA_BUSY(value)               (PUF_STATUSA_BUSY_Msk & (_UINT32_(value) << PUF_STATUSA_BUSY_Pos)) /* Assigment of value for BUSY in the PUF_STATUSA register */
...
#define PUF_DISABLE_ENROLL(value)             (PUF_DISABLE_ENROLL_Msk & (_UINT32_(value) << PUF_DISABLE_ENROLL_Pos)) /* Assigment of value for ENROLL in the PUF_DISABLE register */
...
#define PUF_DISABLE_START(value)              (PUF_DISABLE_START_Msk & (_UINT32_(value) << PUF_DISABLE_START_Pos)) /* Assigment of value for START in the PUF_DISABLE register */
...
#define PUF_DISABLE_RECONSTRUCT(value)        (PUF_DISABLE_RECONSTRUCT_Msk & (_UINT32_(value) << PUF_DISABLE_RECONSTRUCT_Pos)) /* Assigment of value for RECONSTRUCT in the PUF_DISABLE register */
...
#define PUF_DISABLE_STOP(value)               (PUF_DISABLE_STOP_Msk & (_UINT32_(value) << PUF_DISABLE_STOP_Pos)) /* Assigment of value for STOP in the PUF_DISABLE register */
...
#define PUF_DISABLE_GET_KEY(value)            (PUF_DISABLE_GET_KEY_Msk & (_UINT32_(value) << PUF_DISABLE_GET_KEY_Pos)) /* Assigment of value for GET_KEY in the PUF_DISABLE register */
...
#define PUF_DISABLE_UNWRAP(value)             (PUF_DISABLE_UNWRAP_Msk & (_UINT32_(value) << PUF_DISABLE_UNWRAP_Pos)) /* Assigment of value for UNWRAP in the PUF_DISABLE register */
...
#define PUF_DISABLE_WRAP_GEN_RAND(value)      (PUF_DISABLE_WRAP_GEN_RAND_Msk & (_UINT32_(value) << PUF_DISABLE_WRAP_GEN_RAND_Pos)) /* Assigment of value for WRAP_GEN_RAND in the PUF_DISABLE register */
...
#define PUF_DISABLE_WRAP(value)               (PUF_DISABLE_WRAP_Msk & (_UINT32_(value) << PUF_DISABLE_WRAP_Pos)) /* Assigment of value for WRAP in the PUF_DISABLE register */
...
#define PUF_DISABLE_GEN_RAND(value)           (PUF_DISABLE_GEN_RAND_Msk & (_UINT32_(value) << PUF_DISABLE_GEN_RAND_Pos)) /* Assigment of value for GEN_RAND in the PUF_DISABLE register */
...
#define PUF_DISABLE_SKIP_MEM_TEST(value)      (PUF_DISABLE_SKIP_MEM_TEST_Msk & (_UINT32_(value) << PUF_DISABLE_SKIP_MEM_TEST_Pos)) /* Assigment of value for SKIP_MEM_TEST in the PUF_DISABLE register */
...
#define PUF_DISABLE_TEST_MEM(value)           (PUF_DISABLE_TEST_MEM_Msk & (_UINT32_(value) << PUF_DISABLE_TEST_MEM_Pos)) /* Assigment of value for TEST_MEM in the PUF_DISABLE register */
...
#define PUF_DISABLE_TEST_PUF(value)           (PUF_DISABLE_TEST_PUF_Msk & (_UINT32_(value) << PUF_DISABLE_TEST_PUF_Pos)) /* Assigment of value for TEST_PUF in the PUF_DISABLE register */
...
#define PUF_RESTRICT0_RESTRICT_CONTEXT_0(value) (PUF_RESTRICT0_RESTRICT_CONTEXT_0_Msk & (_UINT32_(value) << PUF_RESTRICT0_RESTRICT_CONTEXT_0_Pos)) /* Assigment of value for RESTRICT_CONTEXT_0 in the PUF_RESTRICT0 register */
...
#define PUF_RESTRICT1_RESTRICT_CONTEXT_1(value) (PUF_RESTRICT1_RESTRICT_CONTEXT_1_Msk & (_UINT32_(value) << PUF_RESTRICT1_RESTRICT_CONTEXT_1_Pos)) /* Assigment of value for RESTRICT_CONTEXT_1 in the PUF_RESTRICT1 register */
...
#define PUF_CTRL_PWR_SRAM_PWRSW(value)        (PUF_CTRL_PWR_SRAM_PWRSW_Msk & (_UINT32_(value) << PUF_CTRL_PWR_SRAM_PWRSW_Pos)) /* Assigment of value for SRAM_PWRSW in the PUF_CTRL_PWR register */
...
#define PUF_CTRL_KEY_CLR_PUF_KEY(value)       (PUF_CTRL_KEY_CLR_PUF_KEY_Msk & (_UINT32_(value) << PUF_CTRL_KEY_CLR_PUF_KEY_Pos)) /* Assigment of value for CLR_PUF_KEY in the PUF_CTRL_KEY register */
...
#define PUF_QK_CR_qk_zeroize(value)           (PUF_QK_CR_qk_zeroize_Msk & (_UINT32_(value) << PUF_QK_CR_qk_zeroize_Pos)) /* Assigment of value for qk_zeroize in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_enroll(value)            (PUF_QK_CR_qk_enroll_Msk & (_UINT32_(value) << PUF_QK_CR_qk_enroll_Pos)) /* Assigment of value for qk_enroll in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_start(value)             (PUF_QK_CR_qk_start_Msk & (_UINT32_(value) << PUF_QK_CR_qk_start_Pos)) /* Assigment of value for qk_start in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_reconstruct(value)       (PUF_QK_CR_qk_reconstruct_Msk & (_UINT32_(value) << PUF_QK_CR_qk_reconstruct_Pos)) /* Assigment of value for qk_reconstruct in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_stop(value)              (PUF_QK_CR_qk_stop_Msk & (_UINT32_(value) << PUF_QK_CR_qk_stop_Pos)) /* Assigment of value for qk_stop in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_get_key(value)           (PUF_QK_CR_qk_get_key_Msk & (_UINT32_(value) << PUF_QK_CR_qk_get_key_Pos)) /* Assigment of value for qk_get_key in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_unwrap(value)            (PUF_QK_CR_qk_unwrap_Msk & (_UINT32_(value) << PUF_QK_CR_qk_unwrap_Pos)) /* Assigment of value for qk_unwrap in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_wrap_generated_random(value) (PUF_QK_CR_qk_wrap_generated_random_Msk & (_UINT32_(value) << PUF_QK_CR_qk_wrap_generated_random_Pos)) /* Assigment of value for qk_wrap_generated_random in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_wrap(value)              (PUF_QK_CR_qk_wrap_Msk & (_UINT32_(value) << PUF_QK_CR_qk_wrap_Pos)) /* Assigment of value for qk_wrap in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_generate_random(value)   (PUF_QK_CR_qk_generate_random_Msk & (_UINT32_(value) << PUF_QK_CR_qk_generate_random_Pos)) /* Assigment of value for qk_generate_random in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_test_memory(value)       (PUF_QK_CR_qk_test_memory_Msk & (_UINT32_(value) << PUF_QK_CR_qk_test_memory_Pos)) /* Assigment of value for qk_test_memory in the PUF_QK_CR register */
...
#define PUF_QK_CR_qk_test_puf(value)          (PUF_QK_CR_qk_test_puf_Msk & (_UINT32_(value) << PUF_QK_CR_qk_test_puf_Pos)) /* Assigment of value for qk_test_puf in the PUF_QK_CR register */
...
#define PUF_QK_ORR_qk_result_code(value)      (PUF_QK_ORR_qk_result_code_Msk & (_UINT32_(value) << PUF_QK_ORR_qk_result_code_Pos)) /* Assigment of value for qk_result_code in the PUF_QK_ORR register */
...
#define PUF_QK_ORR_qk_last_operation(value)   (PUF_QK_ORR_qk_last_operation_Msk & (_UINT32_(value) << PUF_QK_ORR_qk_last_operation_Pos)) /* Assigment of value for qk_last_operation in the PUF_QK_ORR register */
...
#define PUF_QK_SR_qk_busy(value)              (PUF_QK_SR_qk_busy_Msk & (_UINT32_(value) << PUF_QK_SR_qk_busy_Pos)) /* Assigment of value for qk_busy in the PUF_QK_SR register */
...
#define PUF_QK_SR_qk_ok(value)                (PUF_QK_SR_qk_ok_Msk & (_UINT32_(value) << PUF_QK_SR_qk_ok_Pos)) /* Assigment of value for qk_ok in the PUF_QK_SR register */
...
#define PUF_QK_SR_qk_error(value)             (PUF_QK_SR_qk_error_Msk & (_UINT32_(value) << PUF_QK_SR_qk_error_Pos)) /* Assigment of value for qk_error in the PUF_QK_SR register */
...
#define PUF_QK_SR_qk_zeroized(value)          (PUF_QK_SR_qk_zeroized_Msk & (_UINT32_(value) << PUF_QK_SR_qk_zeroized_Pos)) /* Assigment of value for qk_zeroized in the PUF_QK_SR register */
...
#define PUF_QK_SR_qk_rejected(value)          (PUF_QK_SR_qk_rejected_Msk & (_UINT32_(value) << PUF_QK_SR_qk_rejected_Pos)) /* Assigment of value for qk_rejected in the PUF_QK_SR register */
...
#define PUF_QK_SR_qk_di_request(value)        (PUF_QK_SR_qk_di_request_Msk & (_UINT32_(value) << PUF_QK_SR_qk_di_request_Pos)) /* Assigment of value for qk_di_request in the PUF_QK_SR register */
...
#define PUF_QK_SR_qk_do_request(value)        (PUF_QK_SR_qk_do_request_Msk & (_UINT32_(value) << PUF_QK_SR_qk_do_request_Pos)) /* Assigment of value for qk_do_request in the PUF_QK_SR register */
...
#define PUF_QK_AR_qk_allow_enroll(value)      (PUF_QK_AR_qk_allow_enroll_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_enroll_Pos)) /* Assigment of value for qk_allow_enroll in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_start(value)       (PUF_QK_AR_qk_allow_start_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_start_Pos)) /* Assigment of value for qk_allow_start in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_reconstruct(value) (PUF_QK_AR_qk_allow_reconstruct_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_reconstruct_Pos)) /* Assigment of value for qk_allow_reconstruct in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_stop(value)        (PUF_QK_AR_qk_allow_stop_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_stop_Pos)) /* Assigment of value for qk_allow_stop in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_get_key(value)     (PUF_QK_AR_qk_allow_get_key_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_get_key_Pos)) /* Assigment of value for qk_allow_get_key in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_unwrap(value)      (PUF_QK_AR_qk_allow_unwrap_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_unwrap_Pos)) /* Assigment of value for qk_allow_unwrap in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_wrap_generated_random(value) (PUF_QK_AR_qk_allow_wrap_generated_random_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_wrap_generated_random_Pos)) /* Assigment of value for qk_allow_wrap_generated_random in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_wrap(value)        (PUF_QK_AR_qk_allow_wrap_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_wrap_Pos)) /* Assigment of value for qk_allow_wrap in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_generate_random(value) (PUF_QK_AR_qk_allow_generate_random_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_generate_random_Pos)) /* Assigment of value for qk_allow_generate_random in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_test_memory(value) (PUF_QK_AR_qk_allow_test_memory_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_test_memory_Pos)) /* Assigment of value for qk_allow_test_memory in the PUF_QK_AR register */
...
#define PUF_QK_AR_qk_allow_test_puf(value)    (PUF_QK_AR_qk_allow_test_puf_Msk & (_UINT32_(value) << PUF_QK_AR_qk_allow_test_puf_Pos)) /* Assigment of value for qk_allow_test_puf in the PUF_QK_AR register */
...
#define PUF_QK_IER_qk_int_en(value)           (PUF_QK_IER_qk_int_en_Msk & (_UINT32_(value) << PUF_QK_IER_qk_int_en_Pos)) /* Assigment of value for qk_int_en in the PUF_QK_IER register */
...
#define PUF_QK_IMR_qk_int_en_busy(value)      (PUF_QK_IMR_qk_int_en_busy_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_busy_Pos)) /* Assigment of value for qk_int_en_busy in the PUF_QK_IMR register */
...
#define PUF_QK_IMR_qk_int_en_ok(value)        (PUF_QK_IMR_qk_int_en_ok_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_ok_Pos)) /* Assigment of value for qk_int_en_ok in the PUF_QK_IMR register */
...
#define PUF_QK_IMR_qk_int_en_error(value)     (PUF_QK_IMR_qk_int_en_error_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_error_Pos)) /* Assigment of value for qk_int_en_error in the PUF_QK_IMR register */
...
#define PUF_QK_IMR_qk_int_en_zeroized(value)  (PUF_QK_IMR_qk_int_en_zeroized_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_zeroized_Pos)) /* Assigment of value for qk_int_en_zeroized in the PUF_QK_IMR register */
...
#define PUF_QK_IMR_qk_int_en_rejected(value)  (PUF_QK_IMR_qk_int_en_rejected_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_rejected_Pos)) /* Assigment of value for qk_int_en_rejected in the PUF_QK_IMR register */
...
#define PUF_QK_IMR_qk_int_en_di_request(value) (PUF_QK_IMR_qk_int_en_di_request_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_di_request_Pos)) /* Assigment of value for qk_int_en_di_request in the PUF_QK_IMR register */
...
#define PUF_QK_IMR_qk_int_en_do_request(value) (PUF_QK_IMR_qk_int_en_do_request_Msk & (_UINT32_(value) << PUF_QK_IMR_qk_int_en_do_request_Pos)) /* Assigment of value for qk_int_en_do_request in the PUF_QK_IMR register */
...
#define PUF_QK_ISR_qk_int_busy(value)         (PUF_QK_ISR_qk_int_busy_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_busy_Pos)) /* Assigment of value for qk_int_busy in the PUF_QK_ISR register */
...
#define PUF_QK_ISR_qk_int_ok(value)           (PUF_QK_ISR_qk_int_ok_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_ok_Pos)) /* Assigment of value for qk_int_ok in the PUF_QK_ISR register */
...
#define PUF_QK_ISR_qk_int_error(value)        (PUF_QK_ISR_qk_int_error_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_error_Pos)) /* Assigment of value for qk_int_error in the PUF_QK_ISR register */
...
#define PUF_QK_ISR_qk_int_zeroized(value)     (PUF_QK_ISR_qk_int_zeroized_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_zeroized_Pos)) /* Assigment of value for qk_int_zeroized in the PUF_QK_ISR register */
...
#define PUF_QK_ISR_qk_int_rejected(value)     (PUF_QK_ISR_qk_int_rejected_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_rejected_Pos)) /* Assigment of value for qk_int_rejected in the PUF_QK_ISR register */
...
#define PUF_QK_ISR_qk_int_di_request(value)   (PUF_QK_ISR_qk_int_di_request_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_di_request_Pos)) /* Assigment of value for qk_int_di_request in the PUF_QK_ISR register */
...
#define PUF_QK_ISR_qk_int_do_request(value)   (PUF_QK_ISR_qk_int_do_request_Msk & (_UINT32_(value) << PUF_QK_ISR_qk_int_do_request_Pos)) /* Assigment of value for qk_int_do_request in the PUF_QK_ISR register */
...
#define PUF_QK_DATA_DEST_qk_dest_dor(value)   (PUF_QK_DATA_DEST_qk_dest_dor_Msk & (_UINT32_(value) << PUF_QK_DATA_DEST_qk_dest_dor_Pos)) /* Assigment of value for qk_dest_dor in the PUF_QK_DATA_DEST register */
...
#define PUF_QK_DATA_DEST_qk_dest_so(value)    (PUF_QK_DATA_DEST_qk_dest_so_Msk & (_UINT32_(value) << PUF_QK_DATA_DEST_qk_dest_so_Pos)) /* Assigment of value for qk_dest_so in the PUF_QK_DATA_DEST register */
...
#define PUF_QK_DATA_SRC_qk_src_dir(value)     (PUF_QK_DATA_SRC_qk_src_dir_Msk & (_UINT32_(value) << PUF_QK_DATA_SRC_qk_src_dir_Pos)) /* Assigment of value for qk_src_dir in the PUF_QK_DATA_SRC register */
...
#define PUF_QK_DATA_SRC_qk_src_si(value)      (PUF_QK_DATA_SRC_qk_src_si_Msk & (_UINT32_(value) << PUF_QK_DATA_SRC_qk_src_si_Pos)) /* Assigment of value for qk_src_si in the PUF_QK_DATA_SRC register */
...
#define PUF_QK_KEY_INDEX_qk_key_inde(value)   (PUF_QK_KEY_INDEX_qk_key_inde_Msk & (_UINT32_(value) << PUF_QK_KEY_INDEX_qk_key_inde_Pos)) /* Assigment of value for qk_key_inde in the PUF_QK_KEY_INDEX register */
...
#define PUF_QK_DIR_qk_di(value)               (PUF_QK_DIR_qk_di_Msk & (_UINT32_(value) << PUF_QK_DIR_qk_di_Pos)) /* Assigment of value for qk_di in the PUF_QK_DIR register */
...
#define PUF_QK_DOR_qk_do(value)               (PUF_QK_DOR_qk_do_Msk & (_UINT32_(value) << PUF_QK_DOR_qk_do_Pos)) /* Assigment of value for qk_do in the PUF_QK_DOR register */
...
#define PUF_QK_MISC_qk_data_endianness(value) (PUF_QK_MISC_qk_data_endianness_Msk & (_UINT32_(value) << PUF_QK_MISC_qk_data_endianness_Pos)) /* Assigment of value for qk_data_endianness in the PUF_QK_MISC register */
...
#define PUF_QK_IF_SR_reg_if_error(value)      (PUF_QK_IF_SR_reg_if_error_Msk & (_UINT32_(value) << PUF_QK_IF_SR_reg_if_error_Pos)) /* Assigment of value for reg_if_error in the PUF_QK_IF_SR register */
...
#define PUF_QK_TEST_qk_bist_enable(value)     (PUF_QK_TEST_qk_bist_enable_Msk & (_UINT32_(value) << PUF_QK_TEST_qk_bist_enable_Pos)) /* Assigment of value for qk_bist_enable in the PUF_QK_TEST register */
...
#define PUF_QK_TEST_qk_bist_running(value)    (PUF_QK_TEST_qk_bist_running_Msk & (_UINT32_(value) << PUF_QK_TEST_qk_bist_running_Pos)) /* Assigment of value for qk_bist_running in the PUF_QK_TEST register */
...
#define PUF_QK_TEST_qk_bist_active(value)     (PUF_QK_TEST_qk_bist_active_Msk & (_UINT32_(value) << PUF_QK_TEST_qk_bist_active_Pos)) /* Assigment of value for qk_bist_active in the PUF_QK_TEST register */
...
#define PUF_QK_TEST_qk_bist_ok(value)         (PUF_QK_TEST_qk_bist_ok_Msk & (_UINT32_(value) << PUF_QK_TEST_qk_bist_ok_Pos)) /* Assigment of value for qk_bist_ok in the PUF_QK_TEST register */
...
#define PUF_QK_TEST_qk_bist_error(value)      (PUF_QK_TEST_qk_bist_error_Msk & (_UINT32_(value) << PUF_QK_TEST_qk_bist_error_Pos)) /* Assigment of value for qk_bist_error in the PUF_QK_TEST register */
...
#define PUF_QK_TEST_qk_allow_bist(value)      (PUF_QK_TEST_qk_allow_bist_Msk & (_UINT32_(value) << PUF_QK_TEST_qk_allow_bist_Pos)) /* Assigment of value for qk_allow_bist in the PUF_QK_TEST register */
...
#define PUF_QK_PSR_qk_puf_score(value)        (PUF_QK_PSR_qk_puf_score_Msk & (_UINT32_(value) << PUF_QK_PSR_qk_puf_score_Pos)) /* Assigment of value for qk_puf_score in the PUF_QK_PSR register */
...
#define PUF_QK_HW_RUC0_qk_restrict_user_context_0(value) (PUF_QK_HW_RUC0_qk_restrict_user_context_0_Msk & (_UINT32_(value) << PUF_QK_HW_RUC0_qk_restrict_user_context_0_Pos)) /* Assigment of value for qk_restrict_user_context_0 in the PUF_QK_HW_RUC0 register */
...
#define PUF_QK_HW_RUC1_qk_restrict_user_context_1(value) (PUF_QK_HW_RUC1_qk_restrict_user_context_1_Msk & (_UINT32_(value) << PUF_QK_HW_RUC1_qk_restrict_user_context_1_Pos)) /* Assigment of value for qk_restrict_user_context_1 in the PUF_QK_HW_RUC1 register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_enroll(value) (PUF_QK_HW_SETTINGS_qk_disable_enroll_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_enroll_Pos)) /* Assigment of value for qk_disable_enroll in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_start(value) (PUF_QK_HW_SETTINGS_qk_disable_start_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_start_Pos)) /* Assigment of value for qk_disable_start in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_reconstruct(value) (PUF_QK_HW_SETTINGS_qk_disable_reconstruct_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_reconstruct_Pos)) /* Assigment of value for qk_disable_reconstruct in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_stop(value) (PUF_QK_HW_SETTINGS_qk_disable_stop_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_stop_Pos)) /* Assigment of value for qk_disable_stop in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_get_key(value) (PUF_QK_HW_SETTINGS_qk_disable_get_key_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_get_key_Pos)) /* Assigment of value for qk_disable_get_key in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_unwrap(value) (PUF_QK_HW_SETTINGS_qk_disable_unwrap_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_unwrap_Pos)) /* Assigment of value for qk_disable_unwrap in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_wrap_generated_random(value) (PUF_QK_HW_SETTINGS_qk_disable_wrap_generated_random_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_wrap_generated_random_Pos)) /* Assigment of value for qk_disable_wrap_generated_random in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_wrap(value) (PUF_QK_HW_SETTINGS_qk_disable_wrap_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_wrap_Pos)) /* Assigment of value for qk_disable_wrap in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_generate_random(value) (PUF_QK_HW_SETTINGS_qk_disable_generate_random_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_generate_random_Pos)) /* Assigment of value for qk_disable_generate_random in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_skip_memory_test(value) (PUF_QK_HW_SETTINGS_qk_skip_memory_test_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_skip_memory_test_Pos)) /* Assigment of value for qk_skip_memory_test in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_test_memory(value) (PUF_QK_HW_SETTINGS_qk_disable_test_memory_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_test_memory_Pos)) /* Assigment of value for qk_disable_test_memory in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_SETTINGS_qk_disable_test_puf(value) (PUF_QK_HW_SETTINGS_qk_disable_test_puf_Msk & (_UINT32_(value) << PUF_QK_HW_SETTINGS_qk_disable_test_puf_Pos)) /* Assigment of value for qk_disable_test_puf in the PUF_QK_HW_SETTINGS register */
...
#define PUF_QK_HW_INFO_qk_config_sp_800_90(value) (PUF_QK_HW_INFO_qk_config_sp_800_90_Msk & (_UINT32_(value) << PUF_QK_HW_INFO_qk_config_sp_800_90_Pos)) /* Assigment of value for qk_config_sp_800_90 in the PUF_QK_HW_INFO register */
...
#define PUF_QK_HW_INFO_qk_config_bist(value)  (PUF_QK_HW_INFO_qk_config_bist_Msk & (_UINT32_(value) << PUF_QK_HW_INFO_qk_config_bist_Pos)) /* Assigment of value for qk_config_bist in the PUF_QK_HW_INFO register */
...
#define PUF_QK_HW_INFO_Reserved(value)        (PUF_QK_HW_INFO_Reserved_Msk & (_UINT32_(value) << PUF_QK_HW_INFO_Reserved_Pos)) /* Assigment of value for Reserved in the PUF_QK_HW_INFO register */
...
#define PUF_QK_HW_INFO_qk_config_wrap(value)  (PUF_QK_HW_INFO_qk_config_wrap_Msk & (_UINT32_(value) << PUF_QK_HW_INFO_qk_config_wrap_Pos)) /* Assigment of value for qk_config_wrap in the PUF_QK_HW_INFO register */
...
#define PUF_QK_HW_INFO_qk_config_type(value)  (PUF_QK_HW_INFO_qk_config_type_Msk & (_UINT32_(value) << PUF_QK_HW_INFO_qk_config_type_Pos)) /* Assigment of value for qk_config_type in the PUF_QK_HW_INFO register */
...
#define PUF_QK_HW_ID_qk_hw_id(value)          (PUF_QK_HW_ID_qk_hw_id_Msk & (_UINT32_(value) << PUF_QK_HW_ID_qk_hw_id_Pos)) /* Assigment of value for qk_hw_id in the PUF_QK_HW_ID register */
...
#define PUF_QK_HW_VER_qk_hw_rev(value)        (PUF_QK_HW_VER_qk_hw_rev_Msk & (_UINT32_(value) << PUF_QK_HW_VER_qk_hw_rev_Pos)) /* Assigment of value for qk_hw_rev in the PUF_QK_HW_VER register */
...
#define PUF_QK_HW_VER_qk_hw_version_minor(value) (PUF_QK_HW_VER_qk_hw_version_minor_Msk & (_UINT32_(value) << PUF_QK_HW_VER_qk_hw_version_minor_Pos)) /* Assigment of value for qk_hw_version_minor in the PUF_QK_HW_VER register */
...
#define PUF_QK_HW_VER_qk_hw_version_major(value) (PUF_QK_HW_VER_qk_hw_version_major_Msk & (_UINT32_(value) << PUF_QK_HW_VER_qk_hw_version_major_Pos)) /* Assigment of value for qk_hw_version_major in the PUF_QK_HW_VER register */
