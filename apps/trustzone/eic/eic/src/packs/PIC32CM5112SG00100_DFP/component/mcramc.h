...
#define MCRAMC_CTRLA_PRIV(value)              (MCRAMC_CTRLA_PRIV_Msk & (_UINT32_(value) << MCRAMC_CTRLA_PRIV_Pos)) /* Assigment of value for PRIV in the MCRAMC_CTRLA register */
...
#define MCRAMC_CTRLA_WS(value)                (MCRAMC_CTRLA_WS_Msk & (_UINT32_(value) << MCRAMC_CTRLA_WS_Pos)) /* Assigment of value for WS in the MCRAMC_CTRLA register */
...
#define MCRAMC_VERSION_VERSION(value)         (MCRAMC_VERSION_VERSION_Msk & (_UINT32_(value) << MCRAMC_VERSION_VERSION_Pos)) /* Assigment of value for VERSION in the MCRAMC_VERSION register */
...
#define MCRAMC_VERSION_MFN(value)             (MCRAMC_VERSION_MFN_Msk & (_UINT32_(value) << MCRAMC_VERSION_MFN_Pos)) /* Assigment of value for MFN in the MCRAMC_VERSION register */
