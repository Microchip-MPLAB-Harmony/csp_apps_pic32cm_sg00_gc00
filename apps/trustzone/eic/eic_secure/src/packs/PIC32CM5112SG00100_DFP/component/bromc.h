...
#define BROMC_CTRLA_SWRST(value)              (BROMC_CTRLA_SWRST_Msk & (_UINT32_(value) << BROMC_CTRLA_SWRST_Pos)) /* Assigment of value for SWRST in the BROMC_CTRLA register */
...
#define BROMC_CTRLA_ENABLE(value)             (BROMC_CTRLA_ENABLE_Msk & (_UINT32_(value) << BROMC_CTRLA_ENABLE_Pos)) /* Assigment of value for ENABLE in the BROMC_CTRLA register */
...
#define BROMC_CTRLA_PRIV(value)               (BROMC_CTRLA_PRIV_Msk & (_UINT32_(value) << BROMC_CTRLA_PRIV_Pos)) /* Assigment of value for PRIV in the BROMC_CTRLA register */
...
#define BROMC_CTRLA_PRMWS(value)              (BROMC_CTRLA_PRMWS_Msk & (_UINT32_(value) << BROMC_CTRLA_PRMWS_Pos)) /* Assigment of value for PRMWS in the BROMC_CTRLA register */
...
#define BROMC_UCFG_BCRCDIS(value)             (BROMC_UCFG_BCRCDIS_Msk & (_UINT32_(value) << BROMC_UCFG_BCRCDIS_Pos)) /* Assigment of value for BCRCDIS in the BROMC_UCFG register */
...
/** \brief BROMC register offsets definitions */
...
/** \brief BROMC register API structure */
typedef struct
