...
#define CAM_CTRLA_SWRST(value)                (CAM_CTRLA_SWRST_Msk & (_UINT32_(value) << CAM_CTRLA_SWRST_Pos)) /* Assigment of value for SWRST in the CAM_CTRLA register */
...
#define CAM_CTRLA_ENABLE(value)               (CAM_CTRLA_ENABLE_Msk & (_UINT32_(value) << CAM_CTRLA_ENABLE_Pos)) /* Assigment of value for ENABLE in the CAM_CTRLA register */
...
#define CAM_CTRLA_PRIV(value)                 (CAM_CTRLA_PRIV_Msk & (_UINT32_(value) << CAM_CTRLA_PRIV_Pos)) /* Assigment of value for PRIV in the CAM_CTRLA register */
...
#define CAM_CTRLA_RUNSTDBY(value)             (CAM_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << CAM_CTRLA_RUNSTDBY_Pos)) /* Assigment of value for RUNSTDBY in the CAM_CTRLA register */
...
#define CAM_STATUSA_OTPLOCK(value)            (CAM_STATUSA_OTPLOCK_Msk & (_UINT32_(value) << CAM_STATUSA_OTPLOCK_Pos)) /* Assigment of value for OTPLOCK in the CAM_STATUSA register */
...
#define CAM_SYNCBUSY_SWRST(value)             (CAM_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << CAM_SYNCBUSY_SWRST_Pos)) /* Assigment of value for SWRST in the CAM_SYNCBUSY register */
...
#define CAM_SYNCBUSY_ENABLE(value)            (CAM_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << CAM_SYNCBUSY_ENABLE_Pos)) /* Assigment of value for ENABLE in the CAM_SYNCBUSY register */
...
#define CAM_CryptoMaster_DMA_Registers__FETCH_ADDR_LSB_FETCH_ADDR_LSB(value) (CAM_CryptoMaster_DMA_Registers__FETCH_ADDR_LSB_FETCH_ADDR_LSB_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__FETCH_ADDR_LSB_FETCH_ADDR_LSB_Pos)) /* Assigment of value for FETCH_ADDR_LSB in the CAM_CryptoMaster_DMA_Registers__FETCH_ADDR_LSB register */
...
#define CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_LEN(value) (CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_LEN_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_LEN_Pos)) /* Assigment of value for FETCH_LEN in the CAM_CryptoMaster_DMA_Registers__FETCH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_CSTADDR(value) (CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_CSTADDR_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_CSTADDR_Pos)) /* Assigment of value for FETCH_CSTADDR in the CAM_CryptoMaster_DMA_Registers__FETCH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_REALIGN(value) (CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_REALIGN_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_REALIGN_Pos)) /* Assigment of value for FETCH_REALIGN in the CAM_CryptoMaster_DMA_Registers__FETCH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_ZPADDING(value) (CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_ZPADDING_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__FETCH_LEN_FETCH_ZPADDING_Pos)) /* Assigment of value for FETCH_ZPADDING in the CAM_CryptoMaster_DMA_Registers__FETCH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__FETCH_TAG_FETCH_TAG(value) (CAM_CryptoMaster_DMA_Registers__FETCH_TAG_FETCH_TAG_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__FETCH_TAG_FETCH_TAG_Pos)) /* Assigment of value for FETCH_TAG in the CAM_CryptoMaster_DMA_Registers__FETCH_TAG register */
...
#define CAM_CryptoMaster_DMA_Registers__PUSH_ADDR_MSB_PUSH_ADDR_MSB(value) (CAM_CryptoMaster_DMA_Registers__PUSH_ADDR_MSB_PUSH_ADDR_MSB_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__PUSH_ADDR_MSB_PUSH_ADDR_MSB_Pos)) /* Assigment of value for PUSH_ADDR_MSB in the CAM_CryptoMaster_DMA_Registers__PUSH_ADDR_MSB register */
...
#define CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_LEN(value) (CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_LEN_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_LEN_Pos)) /* Assigment of value for PUSH_LEN in the CAM_CryptoMaster_DMA_Registers__PUSH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_CSTADDR(value) (CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_CSTADDR_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_CSTADDR_Pos)) /* Assigment of value for PUSH_CSTADDR in the CAM_CryptoMaster_DMA_Registers__PUSH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_REALIGN(value) (CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_REALIGN_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_REALIGN_Pos)) /* Assigment of value for PUSH_REALIGN in the CAM_CryptoMaster_DMA_Registers__PUSH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_DISCARD(value) (CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_DISCARD_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__PUSH_LEN_PUSH_DISCARD_Pos)) /* Assigment of value for PUSH_DISCARD in the CAM_CryptoMaster_DMA_Registers__PUSH_LEN register */
...
#define CAM_CryptoMaster_DMA_Registers__INT_EN_INT_EN(value) (CAM_CryptoMaster_DMA_Registers__INT_EN_INT_EN_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__INT_EN_INT_EN_Pos)) /* Assigment of value for INT_EN in the CAM_CryptoMaster_DMA_Registers__INT_EN register */
...
#define CAM_CryptoMaster_DMA_Registers__INT_ENSET_INT_ENSET(value) (CAM_CryptoMaster_DMA_Registers__INT_ENSET_INT_ENSET_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__INT_ENSET_INT_ENSET_Pos)) /* Assigment of value for INT_ENSET in the CAM_CryptoMaster_DMA_Registers__INT_ENSET register */
...
#define CAM_CryptoMaster_DMA_Registers__INT_ENCLR_INT_ENCLR(value) (CAM_CryptoMaster_DMA_Registers__INT_ENCLR_INT_ENCLR_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__INT_ENCLR_INT_ENCLR_Pos)) /* Assigment of value for INT_ENCLR in the CAM_CryptoMaster_DMA_Registers__INT_ENCLR register */
...
#define CAM_CryptoMaster_DMA_Registers__INT_STATRAW_INT_STATRAW(value) (CAM_CryptoMaster_DMA_Registers__INT_STATRAW_INT_STATRAW_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__INT_STATRAW_INT_STATRAW_Pos)) /* Assigment of value for INT_STATRAW in the CAM_CryptoMaster_DMA_Registers__INT_STATRAW register */
...
#define CAM_CryptoMaster_DMA_Registers__INT_STAT_INT_STAT(value) (CAM_CryptoMaster_DMA_Registers__INT_STAT_INT_STAT_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__INT_STAT_INT_STAT_Pos)) /* Assigment of value for INT_STAT in the CAM_CryptoMaster_DMA_Registers__INT_STAT register */
...
#define CAM_CryptoMaster_DMA_Registers__INT_STATCLR_INT_STATCLR(value) (CAM_CryptoMaster_DMA_Registers__INT_STATCLR_INT_STATCLR_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__INT_STATCLR_INT_STATCLR_Pos)) /* Assigment of value for INT_STATCLR in the CAM_CryptoMaster_DMA_Registers__INT_STATCLR register */
...
#define CAM_CryptoMaster_DMA_Registers__CONFIG_FETCH_CTRL_INDIRECT(value) (CAM_CryptoMaster_DMA_Registers__CONFIG_FETCH_CTRL_INDIRECT_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__CONFIG_FETCH_CTRL_INDIRECT_Pos)) /* Assigment of value for FETCH_CTRL_INDIRECT in the CAM_CryptoMaster_DMA_Registers__CONFIG register */
...
#define CAM_CryptoMaster_DMA_Registers__CONFIG_PUSH_CTRL_INDIRECT(value) (CAM_CryptoMaster_DMA_Registers__CONFIG_PUSH_CTRL_INDIRECT_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__CONFIG_PUSH_CTRL_INDIRECT_Pos)) /* Assigment of value for PUSH_CTRL_INDIRECT in the CAM_CryptoMaster_DMA_Registers__CONFIG register */
...
#define CAM_CryptoMaster_DMA_Registers__CONFIG_FETCH_STOP(value) (CAM_CryptoMaster_DMA_Registers__CONFIG_FETCH_STOP_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__CONFIG_FETCH_STOP_Pos)) /* Assigment of value for FETCH_STOP in the CAM_CryptoMaster_DMA_Registers__CONFIG register */
...
#define CAM_CryptoMaster_DMA_Registers__CONFIG_PUSH_STOP(value) (CAM_CryptoMaster_DMA_Registers__CONFIG_PUSH_STOP_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__CONFIG_PUSH_STOP_Pos)) /* Assigment of value for PUSH_STOP in the CAM_CryptoMaster_DMA_Registers__CONFIG register */
...
#define CAM_CryptoMaster_DMA_Registers__CONFIG_SOFT_RST(value) (CAM_CryptoMaster_DMA_Registers__CONFIG_SOFT_RST_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__CONFIG_SOFT_RST_Pos)) /* Assigment of value for SOFT_RST in the CAM_CryptoMaster_DMA_Registers__CONFIG register */
...
#define CAM_CryptoMaster_DMA_Registers__START_START_FETCH(value) (CAM_CryptoMaster_DMA_Registers__START_START_FETCH_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__START_START_FETCH_Pos)) /* Assigment of value for START_FETCH in the CAM_CryptoMaster_DMA_Registers__START register */
...
#define CAM_CryptoMaster_DMA_Registers__START_START_PUSH(value) (CAM_CryptoMaster_DMA_Registers__START_START_PUSH_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__START_START_PUSH_Pos)) /* Assigment of value for START_PUSH in the CAM_CryptoMaster_DMA_Registers__START register */
...
#define CAM_CryptoMaster_DMA_Registers__STATUS_FETCH_BUSY(value) (CAM_CryptoMaster_DMA_Registers__STATUS_FETCH_BUSY_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__STATUS_FETCH_BUSY_Pos)) /* Assigment of value for FETCH_BUSY in the CAM_CryptoMaster_DMA_Registers__STATUS register */
...
#define CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_BUSY(value) (CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_BUSY_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_BUSY_Pos)) /* Assigment of value for PUSH_BUSY in the CAM_CryptoMaster_DMA_Registers__STATUS register */
...
#define CAM_CryptoMaster_DMA_Registers__STATUS_FETCH_NOT_EMPTY(value) (CAM_CryptoMaster_DMA_Registers__STATUS_FETCH_NOT_EMPTY_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__STATUS_FETCH_NOT_EMPTY_Pos)) /* Assigment of value for FETCH_NOT_EMPTY in the CAM_CryptoMaster_DMA_Registers__STATUS register */
...
#define CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_WAITINGFIFO(value) (CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_WAITINGFIFO_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_WAITINGFIFO_Pos)) /* Assigment of value for PUSH_WAITINGFIFO in the CAM_CryptoMaster_DMA_Registers__STATUS register */
...
#define CAM_CryptoMaster_DMA_Registers__STATUS_SOFT_RST_BUSY(value) (CAM_CryptoMaster_DMA_Registers__STATUS_SOFT_RST_BUSY_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__STATUS_SOFT_RST_BUSY_Pos)) /* Assigment of value for SOFT_RST_BUSY in the CAM_CryptoMaster_DMA_Registers__STATUS register */
...
#define CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_NBDATA(value) (CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_NBDATA_Msk & (_UINT32_(value) << CAM_CryptoMaster_DMA_Registers__STATUS_PUSH_NBDATA_Pos)) /* Assigment of value for PUSH_NBDATA in the CAM_CryptoMaster_DMA_Registers__STATUS register */
...
#define CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA415_HP_AES_GCM_INCLUDED(value) (CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA415_HP_AES_GCM_INCLUDED_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA415_HP_AES_GCM_INCLUDED_Pos)) /* Assigment of value for BA415_HP_AES_GCM_INCLUDED in the CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA416_HP_AES_XTS_INCLUDED(value) (CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA416_HP_AES_XTS_INCLUDED_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA416_HP_AES_XTS_INCLUDED_Pos)) /* Assigment of value for BA416_HP_AES_XTS_INCLUDED in the CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA413_HASH_INCLUDED(value) (CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA413_HASH_INCLUDED_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA413_HASH_INCLUDED_Pos)) /* Assigment of value for BA413_HASH_INCLUDED in the CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA431_NDRNG_INCLUDED(value) (CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA431_NDRNG_INCLUDED_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA431_NDRNG_INCLUDED_Pos)) /* Assigment of value for BA431_NDRNG_INCLUDED in the CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA422_KASUMI_INCLUDED(value) (CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA422_KASUMI_INCLUDED_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG_BA422_KASUMI_INCLUDED_Pos)) /* Assigment of value for BA422_KASUMI_INCLUDED in the CAM_CryptoMaster_HWConf_Registers__INCL_IPS_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_CS(value) (CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_CS_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_CS_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_CS in the CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1 register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_GLITCHPROTECTION(value) (CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_GLITCHPROTECTION_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1_BA411E_AES_HW_CFG_GLITCHPROTECTION_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_GLITCHPROTECTION in the CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_1 register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_EXTKEYS(value) (CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_EXTKEYS_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_EXTKEYS_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_2_EXTKEYS in the CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2 register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_IKGKEYS(value) (CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_IKGKEYS_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2_BA411E_AES_HW_CFG_2_IKGKEYS_Pos)) /* Assigment of value for BA411E_AES_HW_CFG_2_IKGKEYS in the CAM_CryptoMaster_HWConf_Registers__BA411E_AES_HW_CFG_2 register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_PADDING(value) (CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_PADDING_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_PADDING_Pos)) /* Assigment of value for BA413_HASH_HW_CFG_PADDING in the CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_VERIFYDIGEST(value) (CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_VERIFYDIGEST_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_VERIFYDIGEST_Pos)) /* Assigment of value for BA413_HASH_HW_CFG_VERIFYDIGEST in the CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_IKGKEYS(value) (CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_IKGKEYS_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG_BA413_HASH_HW_CFG_IKGKEYS_Pos)) /* Assigment of value for BA413_HASH_HW_CFG_IKGKEYS in the CAM_CryptoMaster_HWConf_Registers__BA413_HASH_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA418_SHA3_HW_CFG_BA418_SHA3_HW_CFG(value) (CAM_CryptoMaster_HWConf_Registers__BA418_SHA3_HW_CFG_BA418_SHA3_HW_CFG_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA418_SHA3_HW_CFG_BA418_SHA3_HW_CFG_Pos)) /* Assigment of value for BA418_SHA3_HW_CFG in the CAM_CryptoMaster_HWConf_Registers__BA418_SHA3_HW_CFG register */
...
#define CAM_CryptoMaster_HWConf_Registers__BA419_SM4_HW_CFG_BA419_SM4_HW_CFG(value) (CAM_CryptoMaster_HWConf_Registers__BA419_SM4_HW_CFG_BA419_SM4_HW_CFG_Msk & (_UINT32_(value) << CAM_CryptoMaster_HWConf_Registers__BA419_SM4_HW_CFG_BA419_SM4_HW_CFG_Pos)) /* Assigment of value for BA419_SM4_HW_CFG in the CAM_CryptoMaster_HWConf_Registers__BA419_SM4_HW_CFG register */
...
#define CAM_RNG_Control_Registers__Control_Enable(value) (CAM_RNG_Control_Registers__Control_Enable_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_Enable_Pos)) /* Assigment of value for Enable in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_LFSREn(value) (CAM_RNG_Control_Registers__Control_LFSREn_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_LFSREn_Pos)) /* Assigment of value for LFSREn in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_TestEn(value) (CAM_RNG_Control_Registers__Control_TestEn_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_TestEn_Pos)) /* Assigment of value for TestEn in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_CondBypass(value) (CAM_RNG_Control_Registers__Control_CondBypass_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_CondBypass_Pos)) /* Assigment of value for CondBypass in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_IntEnRep(value) (CAM_RNG_Control_Registers__Control_IntEnRep_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_IntEnRep_Pos)) /* Assigment of value for IntEnRep in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_IntEnProp(value) (CAM_RNG_Control_Registers__Control_IntEnProp_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_IntEnProp_Pos)) /* Assigment of value for IntEnProp in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_IntEnFull(value) (CAM_RNG_Control_Registers__Control_IntEnFull_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_IntEnFull_Pos)) /* Assigment of value for IntEnFull in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_SoftRst(value) (CAM_RNG_Control_Registers__Control_SoftRst_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_SoftRst_Pos)) /* Assigment of value for SoftRst in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_IntEnPre(value) (CAM_RNG_Control_Registers__Control_IntEnPre_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_IntEnPre_Pos)) /* Assigment of value for IntEnPre in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_IntEnAlm(value) (CAM_RNG_Control_Registers__Control_IntEnAlm_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_IntEnAlm_Pos)) /* Assigment of value for IntEnAlm in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_ForceActiveROs(value) (CAM_RNG_Control_Registers__Control_ForceActiveROs_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_ForceActiveROs_Pos)) /* Assigment of value for ForceActiveROs in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_HealthTestBypass(value) (CAM_RNG_Control_Registers__Control_HealthTestBypass_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_HealthTestBypass_Pos)) /* Assigment of value for HealthTestBypass in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_AIS31Bypass(value) (CAM_RNG_Control_Registers__Control_AIS31Bypass_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_AIS31Bypass_Pos)) /* Assigment of value for AIS31Bypass in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_HealthTestSel(value) (CAM_RNG_Control_Registers__Control_HealthTestSel_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_HealthTestSel_Pos)) /* Assigment of value for HealthTestSel in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_AIS31TestSel(value) (CAM_RNG_Control_Registers__Control_AIS31TestSel_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_AIS31TestSel_Pos)) /* Assigment of value for AIS31TestSel in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_Nb128BitBlocks(value) (CAM_RNG_Control_Registers__Control_Nb128BitBlocks_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_Nb128BitBlocks_Pos)) /* Assigment of value for Nb128BitBlocks in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__Control_FifoWriteStartUp(value) (CAM_RNG_Control_Registers__Control_FifoWriteStartUp_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Control_FifoWriteStartUp_Pos)) /* Assigment of value for FifoWriteStartUp in the CAM_RNG_Control_Registers__Control register */
...
#define CAM_RNG_Control_Registers__FIFOLevel_FIFOLevel(value) (CAM_RNG_Control_Registers__FIFOLevel_FIFOLevel_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__FIFOLevel_FIFOLevel_Pos)) /* Assigment of value for FIFOLevel in the CAM_RNG_Control_Registers__FIFOLevel register */
...
#define CAM_RNG_Control_Registers__FIFOThreshold_FIFOThreshold(value) (CAM_RNG_Control_Registers__FIFOThreshold_FIFOThreshold_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__FIFOThreshold_FIFOThreshold_Pos)) /* Assigment of value for FIFOThreshold in the CAM_RNG_Control_Registers__FIFOThreshold register */
...
#define CAM_RNG_Control_Registers__FIFODepth_FIFODepth(value) (CAM_RNG_Control_Registers__FIFODepth_FIFODepth_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__FIFODepth_FIFODepth_Pos)) /* Assigment of value for FIFODepth in the CAM_RNG_Control_Registers__FIFODepth register */
...
#define CAM_RNG_Control_Registers__Key0_Key0(value) (CAM_RNG_Control_Registers__Key0_Key0_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Key0_Key0_Pos)) /* Assigment of value for Key0 in the CAM_RNG_Control_Registers__Key0 register */
...
#define CAM_RNG_Control_Registers__Key1_Key1(value) (CAM_RNG_Control_Registers__Key1_Key1_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Key1_Key1_Pos)) /* Assigment of value for Key1 in the CAM_RNG_Control_Registers__Key1 register */
...
#define CAM_RNG_Control_Registers__Key2_Key2(value) (CAM_RNG_Control_Registers__Key2_Key2_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Key2_Key2_Pos)) /* Assigment of value for Key2 in the CAM_RNG_Control_Registers__Key2 register */
...
#define CAM_RNG_Control_Registers__Key3_Key3(value) (CAM_RNG_Control_Registers__Key3_Key3_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Key3_Key3_Pos)) /* Assigment of value for Key3 in the CAM_RNG_Control_Registers__Key3 register */
...
#define CAM_RNG_Control_Registers__TestData_TestData(value) (CAM_RNG_Control_Registers__TestData_TestData_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__TestData_TestData_Pos)) /* Assigment of value for TestData in the CAM_RNG_Control_Registers__TestData register */
...
#define CAM_RNG_Control_Registers__PropThreshold_PropThreshold(value) (CAM_RNG_Control_Registers__PropThreshold_PropThreshold_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__PropThreshold_PropThreshold_Pos)) /* Assigment of value for PropThreshold in the CAM_RNG_Control_Registers__PropThreshold register */
...
#define CAM_RNG_Control_Registers__Status_TestDataBusy(value) (CAM_RNG_Control_Registers__Status_TestDataBusy_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_TestDataBusy_Pos)) /* Assigment of value for TestDataBusy in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_State(value) (CAM_RNG_Control_Registers__Status_State_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_State_Pos)) /* Assigment of value for State in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_RepFail(value) (CAM_RNG_Control_Registers__Status_RepFail_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_RepFail_Pos)) /* Assigment of value for RepFail in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_PropFail(value) (CAM_RNG_Control_Registers__Status_PropFail_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_PropFail_Pos)) /* Assigment of value for PropFail in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_FullInt(value) (CAM_RNG_Control_Registers__Status_FullInt_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_FullInt_Pos)) /* Assigment of value for FullInt in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_PreInt(value) (CAM_RNG_Control_Registers__Status_PreInt_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_PreInt_Pos)) /* Assigment of value for PreInt in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_AlmInt(value) (CAM_RNG_Control_Registers__Status_AlmInt_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_AlmInt_Pos)) /* Assigment of value for AlmInt in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_StartUpFail(value) (CAM_RNG_Control_Registers__Status_StartUpFail_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_StartUpFail_Pos)) /* Assigment of value for StartUpFail in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__Status_FifoAccFail(value) (CAM_RNG_Control_Registers__Status_FifoAccFail_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__Status_FifoAccFail_Pos)) /* Assigment of value for FifoAccFail in the CAM_RNG_Control_Registers__Status register */
...
#define CAM_RNG_Control_Registers__InitWaitVal_InitWaitVal(value) (CAM_RNG_Control_Registers__InitWaitVal_InitWaitVal_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__InitWaitVal_InitWaitVal_Pos)) /* Assigment of value for InitWaitVal in the CAM_RNG_Control_Registers__InitWaitVal register */
...
#define CAM_RNG_Control_Registers__DisableOsc0_DisableOsc0(value) (CAM_RNG_Control_Registers__DisableOsc0_DisableOsc0_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__DisableOsc0_DisableOsc0_Pos)) /* Assigment of value for DisableOsc0 in the CAM_RNG_Control_Registers__DisableOsc0 register */
...
#define CAM_RNG_Control_Registers__DisableOsc1_DisableOsc1(value) (CAM_RNG_Control_Registers__DisableOsc1_DisableOsc1_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__DisableOsc1_DisableOsc1_Pos)) /* Assigment of value for DisableOsc1 in the CAM_RNG_Control_Registers__DisableOsc1 register */
...
#define CAM_RNG_Control_Registers__SwOffTmrVal_SwOffTmrVal(value) (CAM_RNG_Control_Registers__SwOffTmrVal_SwOffTmrVal_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__SwOffTmrVal_SwOffTmrVal_Pos)) /* Assigment of value for SwOffTmrVal in the CAM_RNG_Control_Registers__SwOffTmrVal register */
...
#define CAM_RNG_Control_Registers__ClkDiv_ClkDiv(value) (CAM_RNG_Control_Registers__ClkDiv_ClkDiv_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__ClkDiv_ClkDiv_Pos)) /* Assigment of value for ClkDiv in the CAM_RNG_Control_Registers__ClkDiv register */
...
#define CAM_RNG_Control_Registers__AIS31Conf0_StartUpThreshold(value) (CAM_RNG_Control_Registers__AIS31Conf0_StartUpThreshold_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Conf0_StartUpThreshold_Pos)) /* Assigment of value for StartUpThreshold in the CAM_RNG_Control_Registers__AIS31Conf0 register */
...
#define CAM_RNG_Control_Registers__AIS31Conf0_OnlineThreshold(value) (CAM_RNG_Control_Registers__AIS31Conf0_OnlineThreshold_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Conf0_OnlineThreshold_Pos)) /* Assigment of value for OnlineThreshold in the CAM_RNG_Control_Registers__AIS31Conf0 register */
...
#define CAM_RNG_Control_Registers__AIS31Conf1_OnlineRepThreshold(value) (CAM_RNG_Control_Registers__AIS31Conf1_OnlineRepThreshold_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Conf1_OnlineRepThreshold_Pos)) /* Assigment of value for OnlineRepThreshold in the CAM_RNG_Control_Registers__AIS31Conf1 register */
...
#define CAM_RNG_Control_Registers__AIS31Conf1_HExpectedValue(value) (CAM_RNG_Control_Registers__AIS31Conf1_HExpectedValue_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Conf1_HExpectedValue_Pos)) /* Assigment of value for HExpectedValue in the CAM_RNG_Control_Registers__AIS31Conf1 register */
...
#define CAM_RNG_Control_Registers__AIS31Conf2_HMin(value) (CAM_RNG_Control_Registers__AIS31Conf2_HMin_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Conf2_HMin_Pos)) /* Assigment of value for HMin in the CAM_RNG_Control_Registers__AIS31Conf2 register */
...
#define CAM_RNG_Control_Registers__AIS31Conf2_HMa(value) (CAM_RNG_Control_Registers__AIS31Conf2_HMa_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Conf2_HMa_Pos)) /* Assigment of value for HMa in the CAM_RNG_Control_Registers__AIS31Conf2 register */
...
#define CAM_RNG_Control_Registers__AIS31Status_NumPrelimAlarms(value) (CAM_RNG_Control_Registers__AIS31Status_NumPrelimAlarms_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Status_NumPrelimAlarms_Pos)) /* Assigment of value for NumPrelimAlarms in the CAM_RNG_Control_Registers__AIS31Status register */
...
#define CAM_RNG_Control_Registers__AIS31Status_PrelimNoiseAlarmRep(value) (CAM_RNG_Control_Registers__AIS31Status_PrelimNoiseAlarmRep_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__AIS31Status_PrelimNoiseAlarmRep_Pos)) /* Assigment of value for PrelimNoiseAlarmRep in the CAM_RNG_Control_Registers__AIS31Status register */
...
#define CAM_RNG_Control_Registers__HwConfig_NumbOfRings(value) (CAM_RNG_Control_Registers__HwConfig_NumbOfRings_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__HwConfig_NumbOfRings_Pos)) /* Assigment of value for NumbOfRings in the CAM_RNG_Control_Registers__HwConfig register */
...
#define CAM_RNG_Control_Registers__HwConfig_AIS31(value) (CAM_RNG_Control_Registers__HwConfig_AIS31_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__HwConfig_AIS31_Pos)) /* Assigment of value for AIS31 in the CAM_RNG_Control_Registers__HwConfig register */
...
#define CAM_RNG_Control_Registers__HwConfig_AIS31Full(value) (CAM_RNG_Control_Registers__HwConfig_AIS31Full_Msk & (_UINT32_(value) << CAM_RNG_Control_Registers__HwConfig_AIS31Full_Pos)) /* Assigment of value for AIS31Full in the CAM_RNG_Control_Registers__HwConfig register */
...
#define CAM_PK_Registers__Pointers_OpPtrA(value) (CAM_PK_Registers__Pointers_OpPtrA_Msk & (_UINT32_(value) << CAM_PK_Registers__Pointers_OpPtrA_Pos)) /* Assigment of value for OpPtrA in the CAM_PK_Registers__Pointers register */
...
#define CAM_PK_Registers__Pointers_OpPtrB(value) (CAM_PK_Registers__Pointers_OpPtrB_Msk & (_UINT32_(value) << CAM_PK_Registers__Pointers_OpPtrB_Pos)) /* Assigment of value for OpPtrB in the CAM_PK_Registers__Pointers register */
...
#define CAM_PK_Registers__Pointers_OpPtrC(value) (CAM_PK_Registers__Pointers_OpPtrC_Msk & (_UINT32_(value) << CAM_PK_Registers__Pointers_OpPtrC_Pos)) /* Assigment of value for OpPtrC in the CAM_PK_Registers__Pointers register */
...
#define CAM_PK_Registers__Pointers_OpPtrN(value) (CAM_PK_Registers__Pointers_OpPtrN_Msk & (_UINT32_(value) << CAM_PK_Registers__Pointers_OpPtrN_Pos)) /* Assigment of value for OpPtrN in the CAM_PK_Registers__Pointers register */
...
#define CAM_PK_Registers__Command_OpeAddr(value) (CAM_PK_Registers__Command_OpeAddr_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_OpeAddr_Pos)) /* Assigment of value for OpeAddr in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_FieldF(value) (CAM_PK_Registers__Command_FieldF_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_FieldF_Pos)) /* Assigment of value for FieldF in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_OpBytesM1(value) (CAM_PK_Registers__Command_OpBytesM1_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_OpBytesM1_Pos)) /* Assigment of value for OpBytesM1 in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_RandMod(value) (CAM_PK_Registers__Command_RandMod_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_RandMod_Pos)) /* Assigment of value for RandMod in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_SelCurve(value) (CAM_PK_Registers__Command_SelCurve_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_SelCurve_Pos)) /* Assigment of value for SelCurve in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_RandKE(value) (CAM_PK_Registers__Command_RandKE_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_RandKE_Pos)) /* Assigment of value for RandKE in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_RandProj(value) (CAM_PK_Registers__Command_RandProj_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_RandProj_Pos)) /* Assigment of value for RandProj in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_Edwards(value) (CAM_PK_Registers__Command_Edwards_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_Edwards_Pos)) /* Assigment of value for Edwards in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_SwapBytes(value) (CAM_PK_Registers__Command_SwapBytes_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_SwapBytes_Pos)) /* Assigment of value for SwapBytes in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_FlagA(value) (CAM_PK_Registers__Command_FlagA_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_FlagA_Pos)) /* Assigment of value for FlagA in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_FlagB(value) (CAM_PK_Registers__Command_FlagB_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_FlagB_Pos)) /* Assigment of value for FlagB in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Command_CalcR2(value) (CAM_PK_Registers__Command_CalcR2_Msk & (_UINT32_(value) << CAM_PK_Registers__Command_CalcR2_Pos)) /* Assigment of value for CalcR2 in the CAM_PK_Registers__Command register */
...
#define CAM_PK_Registers__Control_Start(value) (CAM_PK_Registers__Control_Start_Msk & (_UINT32_(value) << CAM_PK_Registers__Control_Start_Pos)) /* Assigment of value for Start in the CAM_PK_Registers__Control register */
...
#define CAM_PK_Registers__Control_ClearIRQ(value) (CAM_PK_Registers__Control_ClearIRQ_Msk & (_UINT32_(value) << CAM_PK_Registers__Control_ClearIRQ_Pos)) /* Assigment of value for ClearIRQ in the CAM_PK_Registers__Control register */
...
#define CAM_PK_Registers__Status_ErrorFlags(value) (CAM_PK_Registers__Status_ErrorFlags_Msk & (_UINT32_(value) << CAM_PK_Registers__Status_ErrorFlags_Pos)) /* Assigment of value for ErrorFlags in the CAM_PK_Registers__Status register */
...
#define CAM_PK_Registers__Status_PK_Busy(value) (CAM_PK_Registers__Status_PK_Busy_Msk & (_UINT32_(value) << CAM_PK_Registers__Status_PK_Busy_Pos)) /* Assigment of value for PK_Busy in the CAM_PK_Registers__Status register */
...
#define CAM_PK_Registers__Status_IntrptStatus(value) (CAM_PK_Registers__Status_IntrptStatus_Msk & (_UINT32_(value) << CAM_PK_Registers__Status_IntrptStatus_Pos)) /* Assigment of value for IntrptStatus in the CAM_PK_Registers__Status register */
...
#define CAM_PK_Registers__Status_FailPtr(value) (CAM_PK_Registers__Status_FailPtr_Msk & (_UINT32_(value) << CAM_PK_Registers__Status_FailPtr_Pos)) /* Assigment of value for FailPtr in the CAM_PK_Registers__Status register */
...
#define CAM_PK_Registers__Timer_Timer(value)  (CAM_PK_Registers__Timer_Timer_Msk & (_UINT32_(value) << CAM_PK_Registers__Timer_Timer_Pos)) /* Assigment of value for Timer in the CAM_PK_Registers__Timer register */
...
#define CAM_PK_Registers__HwConfig_MaxOpSize(value) (CAM_PK_Registers__HwConfig_MaxOpSize_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_MaxOpSize_Pos)) /* Assigment of value for MaxOpSize in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_NbMult(value) (CAM_PK_Registers__HwConfig_NbMult_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_NbMult_Pos)) /* Assigment of value for NbMult in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_PrimeField(value) (CAM_PK_Registers__HwConfig_PrimeField_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_PrimeField_Pos)) /* Assigment of value for PrimeField in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_BinaryField(value) (CAM_PK_Registers__HwConfig_BinaryField_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_BinaryField_Pos)) /* Assigment of value for BinaryField in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_ECC(value) (CAM_PK_Registers__HwConfig_ECC_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_ECC_Pos)) /* Assigment of value for ECC in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_P256(value) (CAM_PK_Registers__HwConfig_P256_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_P256_Pos)) /* Assigment of value for P256 in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_P384(value) (CAM_PK_Registers__HwConfig_P384_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_P384_Pos)) /* Assigment of value for P384 in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_P521(value) (CAM_PK_Registers__HwConfig_P521_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_P521_Pos)) /* Assigment of value for P521 in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_P192(value) (CAM_PK_Registers__HwConfig_P192_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_P192_Pos)) /* Assigment of value for P192 in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_X25519(value) (CAM_PK_Registers__HwConfig_X25519_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_X25519_Pos)) /* Assigment of value for X25519 in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_AHBMaster(value) (CAM_PK_Registers__HwConfig_AHBMaster_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_AHBMaster_Pos)) /* Assigment of value for AHBMaster in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_DisableSM(value) (CAM_PK_Registers__HwConfig_DisableSM_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_DisableSM_Pos)) /* Assigment of value for DisableSM in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_DisableClrMem(value) (CAM_PK_Registers__HwConfig_DisableClrMem_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_DisableClrMem_Pos)) /* Assigment of value for DisableClrMem in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__HwConfig_DisableCM(value) (CAM_PK_Registers__HwConfig_DisableCM_Msk & (_UINT32_(value) << CAM_PK_Registers__HwConfig_DisableCM_Pos)) /* Assigment of value for DisableCM in the CAM_PK_Registers__HwConfig register */
...
#define CAM_PK_Registers__OpSize_OpSize(value) (CAM_PK_Registers__OpSize_OpSize_Msk & (_UINT32_(value) << CAM_PK_Registers__OpSize_OpSize_Pos)) /* Assigment of value for OpSize in the CAM_PK_Registers__OpSize register */
...
#define CAM_PK_Registers__MemOffset_MemOffset(value) (CAM_PK_Registers__MemOffset_MemOffset_Msk & (_UINT32_(value) << CAM_PK_Registers__MemOffset_MemOffset_Pos)) /* Assigment of value for MemOffset in the CAM_PK_Registers__MemOffset register */
...
#define CAM_PK_Registers__MicroCodeOffset_MicroCodeOffset(value) (CAM_PK_Registers__MicroCodeOffset_MicroCodeOffset_Msk & (_UINT32_(value) << CAM_PK_Registers__MicroCodeOffset_MicroCodeOffset_Pos)) /* Assigment of value for MicroCodeOffset in the CAM_PK_Registers__MicroCodeOffset register */
#define CAM_PK_Registers__MicroCodeOffset_Msk _UINT32_(0xFFFFFFFF)                                 /* (CAM_PK_Registers__MicroCodeOffset) Register Mask  */


/** \brief CAM register offsets definitions */
...
/** \brief CAM register API structure */
typedef struct
